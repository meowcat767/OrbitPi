...
This is the readme for OrbitPi, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. OrbitPi) > Ok.
...
- To run the project find OrbitPi.java (which will be in under src/main/java/site/meowcat) and right click > Run 'OrbitPi'
